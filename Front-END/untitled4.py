...
tk.Label(master, text="HARVESTOR ",bg="cyan").grid(row=0,column=1) 
master.configure(background="cyan") 

tk.Label(master,text="HARVESTOR_ID",bg="cyan").grid(row=1) 
tk.Label(master,text="HARVESTOR_NAME",bg="cyan").grid(row=2) 
tk.Label(master,text="HARVESTOR_PHONE_NUMBER",bg="cyan").grid(row=3) 
e1 = tk.Entry(master)
e2 = tk.Entry(master)
e3 = tk.Entry(master)
e4 = tk.Entry(master)
